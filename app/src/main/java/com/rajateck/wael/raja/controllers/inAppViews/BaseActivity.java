...
import com.rajateck.wael.raja.controllers.inAppViews.ourBranches.OurBranchesFragment;
...
public class BaseActivity extends FragmentActivity implements View.OnClickListener {
    ...
    private FrameLayout ourBrachesFrame;
    ...
    private void changeStatusBarColor() {
        try {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                ...
                window.setStatusBarColor(Color.parseColor("#ee3c34"));
            }
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    ...
    private void findViews() {
        ...
        ourBrachesFrame = (FrameLayout) findViewById(R.id.our_braches_frame);
        ...
        ourBrachesFrame.setOnClickListener(this);
    ...
    public void onClick(View view) {
        ...
        } else if (view == ourBrachesFrame) {
            openOurBrachesScreen();
        }
    }
    ...
    private void openOurBrachesScreen() {
        mDrawerLayout.closeDrawer(Gravity.LEFT);
        fragmentHolderFull.setVisibility(View.VISIBLE);
        YoYo.with(Techniques.SlideInUp).interpolate(new AccelerateInterpolator()).duration(1).playOn(fragmentHolderFull);
        OurBranchesFragment ourBranchesFragment = new OurBranchesFragment();
        tabStackerFull.addFragment(ourBranchesFragment, null);  // no animation
    }
