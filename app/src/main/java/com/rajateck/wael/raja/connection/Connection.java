...
import com.rajateck.wael.raja.delegates.generalDelegates.CheckWarrantyDelegate;
...
public class Connection {
    ...
    public static void getMobilesList(final GetMobileListDelegate getMobileListDelegate,
        ...
        try {
            // TODO: 11/11/17 change this request to use URL connection
            try {
                                    ...
                                    if (responseCode.equalsIgnoreCase(ResponseCodes.Success.getCode())) {
                                        ...
                                        try {
                                            ...
                                            if (jsonArray.length() == 0) {
                                                ...
                                                if (warrentyCheckDetails != null) {//&&warrentyCheckDetails.getStartdate() != null
    ...
    public static void activateWarrantyForIMEI(final ActivateMobileNumberDelegate activateMobileNumberDelegate,
                                               final String imei,
                                               final String mobile,
                                               final Context context) {
        try {
            ...
            if (imei == null ||
                    mobile == null) {
                activateMobileNumberDelegate.activateDeviceDelegateParameterError();
                return;
            }


            try {
                System.out.println("Connection : Post Warranty Activation list  URL  = " + APIEndpoints.PostWarrantyActivation.getLink());
            } catch (Exception ex) {
                ex.printStackTrace();
            }
            ...
            try {
                ...
                System.out.println("Connection.activateWarrantyForIMEI body : " + jsonObject);
            } catch (Exception ex) {
                ex.printStackTrace();
            }

            Ion.with(context)
                    .load("POST", APIEndpoints.PostWarrantyActivation.getLink())
                    .setTimeout(30000)
                    .addHeader("Content-Type", "application/json")
                        ...
                        public void onCompleted(Exception e, Response<String> result) {
                            try {
                                if (e == null) {
                                    ...
                                    try {
                                        System.out.println("Connection.onCompleted : post list result code= " + responseCode);
                                    ...
                                    if (responseCode.equalsIgnoreCase(ResponseCodes.Success.getCode())) {
                                        ...
                                        try {
                                            ...
                                            System.out.println("Connection.onCompleted : post list result = " + jsonObject.toString());
                                            WarrentyCheckDetails warrentyCheckDetails = new WarrentyCheckDetails(jsonObject);
                                            if (warrentyCheckDetails != null) {
                                                activateMobileNumberDelegate.activateDeviceDelegateSuccess(warrentyCheckDetails);
                                            } else {
                                                if (jsonObject != null) {
                                                    String errorMessage = jsonObject.optString("error");
                                                    if (errorMessage != null) {
                                                        System.out.println("Connection.onCompleted : error message 1");
                                                        activateMobileNumberDelegate.activateDeviceDelegateFailure(errorMessage);
                                                    } else {
                                                        System.out.println("Connection.onCompleted failure 22");
                                                        activateMobileNumberDelegate.activateDeviceConnectionErrorDelegate();
                                                    }
                                                } else {
                                                    System.out.println("Connection.onCompleted failure 33");
                                                    activateMobileNumberDelegate.activateDeviceConnectionErrorDelegate();
                                                }
                                            }
                                        } catch (Exception ex) {
    ...
    public static void getBranches(final GetBranchesDelegate branchesDelegate,
                                   final Context context) {
        try {

            try {
                System.out.println("Connection : GetBranches list  URL  = " + APIEndpoints.GetBranches.getLink());
            } catch (Exception ex) {
                ex.printStackTrace();
            }

            Ion.with(context)
                    .load("GET", APIEndpoints.GetBranches.getLink())
                    .setTimeout(30000)
                    .addHeader("Content-Type", "application/json")
                    .asString()
                    .withResponse()
                                ...
                                if (e == null) {
                                    ...
                                    if (responseCode.equalsIgnoreCase(ResponseCodes.Success.getCode())) {
                                        ...
                                        try {
                                            JSONArray jsonArray = new JSONArray(result.getResult().toString());
                                            System.out.println("Connection.onCompleted : Accessories list result = " + jsonArray.toString());
                                            ArrayList<Branches> hardWaresItems = Branches.getBranchesList(jsonArray);
                                            if (hardWaresItems == null) {
                                                branchesDelegate.GetBranchesConnectionErrorDelegate();
                                            } else {
                                                branchesDelegate.GetBranchesSuccessDelegate(hardWaresItems, true);
                                            }
                                        } catch (Exception ex) {
                                            ex.printStackTrace();
                                            branchesDelegate.GetBranchesConnectionErrorDelegate();
