...
//                                ((RagaListItem) holder).getIcon_holder().setVisibility(View.GONE);
            ...
            ((RagaListItem) holder).getItemName().setText(OffersItems.get(position).getBody().getValue());
            ((RagaListItem) holder).getCreated_date().setText(OffersItems.get(position).getCreated());
